...
#
#         print(request.GET.get("price-min"), request.GET.get("price-max"), request.GET.get("type"))
#
#         try:
...
#         products = Product.objcets.filter(is_public=False)
#         return products
#
...
# class CustomSearchHandler(SimpleProductSearchHandler):
#
#     def get_queryset(self, **kwargs):
#         print("inside get qs")
#         qs = Product.objects.browsable().base_queryset().filter(is_public=False)
#         if self.categories:
