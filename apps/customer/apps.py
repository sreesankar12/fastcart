...
class CustomerConfig(OscarConfig):
    ...
    def ready(self):
        ...
        self.invite_friend = get_class('customer.views', 'InviteFriend')
        self.join_by_referel = get_class('customer.views', 'JoinByReferral')
        ...
        self.account_activate_view = get_class('customer.views', 'ActivateAccountWithToken')
    ...
    def get_urls(self):
        urls = [
            ...
            path('activate/<uidb64>/<token>/', self.account_activate_view.as_view(), name="activate"),
            ...
            path('invite/', login_required(self.invite_friend.as_view()), name='invite-friend'),
            path('referel/<invite_code>/', self.join_by_referel.as_view(), name='referel'),
